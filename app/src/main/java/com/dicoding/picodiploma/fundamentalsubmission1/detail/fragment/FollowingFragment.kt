...
import com.dicoding.picodiploma.fundamentalsubmission1.detail.model.FollowingViewModel
import com.dicoding.picodiploma.fundamentalsubmission1.detail.User
import com.dicoding.picodiploma.fundamentalsubmission1.adapter.FollowingAdapter
...
class FollowingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (getUsername != null) {
            followingViewModel.getFollowing(getUsername)
        }
    }

    private fun setDataToFragment(listFollowing: List<User>) {
    ...
    companion object {
        ...
        fun newInstance(loginUser: String?): FollowingFragment {
